...
KC: Eve would you consider bringing in PM2.5 and PM2.5 percentile? 
These are key drivers of respiratory illness, eg refineries, agriculture 
spraying, wildfire smoke. We could potentially give up diesel and toxic release
by taking PM2.5, as I believe PM2.5 applies to any pollutant of that particulate
size regardless of origin/source.
...
data from 2015 to 2022. Datasets 2 and 3 contain data on age, 
but age categories do not match and will need to be re-categorized.
