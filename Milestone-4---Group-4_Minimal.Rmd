...
##For Milestone 4, we perform a final analysiS TO address our 2 research questions:
...
##Note: Correlation Coefficient is found to be 0.751
```{r}
# Calculate correlation coefficient
...
#Correlation of Race Ethnicity and PM2.5 Measurements to detect impacted demographic groups
```{r}
