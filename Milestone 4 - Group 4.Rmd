...
```
# We next looked at data on a census level within the counties to understand how asthma ED visits are districuted within the counties. Eight out of the eleven Central Vally counties are among those with the highest median ED visit rate prompting us to further explore this subset.
