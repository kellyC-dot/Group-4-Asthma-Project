...
# Summary Plotly Bar Asthma ED Visit Rates and CES Scores for Central Valley Counties Subset
...
plot_ly(
  ...
  layout(
    title = "CES Scores by Central Valley Counties",
    xaxis = list(
      title = "County",
      categoryorder = "array",
...
datatable(
  correlation_matrix,
  options = list(
    pageLength = 6,  # Display 10 rows per page
    autoWidth = TRUE, # Automatically adjust column widths
  ...
  caption = htmltools::tags$caption(
    ...
    "Correlation Between Age Group Visits and Pollution Variables (Central Valley, 2019)"
  )
)
...
scatter_plot <- ggplot(long_data, aes(x = Pollution_Value, y = Asthma_Visits)) +
  ...
  labs(
    title = "Pollution Variables vs Median Asthma ED Visits by Age Group (Central Valley)",
