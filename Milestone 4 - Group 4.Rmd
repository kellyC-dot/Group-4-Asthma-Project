...
# Scatterplots: Mean CES 4.0 Score by County ranked in descending order by asthma ED visits to evaluate potential correlation
...
##Preparare for Geospatial ER Asthma Choropleth Overlay Dot Density for Demography
```{r}
