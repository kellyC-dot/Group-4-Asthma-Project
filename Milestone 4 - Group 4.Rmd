...
asthma_long$Variable <- factor(asthma_long$Variable, 
                                levels = c("pm2_5_median_by_county", 
                                           "education_median_by_county", 
                                           "unemployment_median_by_county", 
                                           "poverty_median_by_county"))
...
ggplot(asthma_long, aes(x = Value, y = asthma_median_by_county_ds1)) +
  ...
  theme_minimal() +
  theme(
    axis.title = element_text(size = 8),  # Adjust axis label font size
...
```
# Boxplots: Median Age Adjusted Asthma ED Visit Rate vs Mean CES 4.0 Score
```{r}
...
ggplot(asthma_measures_df2a_clean, aes(x = reorder(county, asthma, FUN = median), y = asthma)) +
  ...
  labs(
    title = "Boxplots of Asthma Values by County",
    x = "County",
    y = "Asthma"
  ) +
  theme_minimal() +
...
ggplot(asthma_all_join, aes(x = reorder(county, asthma_median_by_county_ds1, FUN = median), y = mean_ces_score)) +
  ...
  labs(
  title = "Scatterplot of CES Score by County",
  x = "County",
  y = "CES 4.0 Score"
  ) +
 theme_minimal() +
...
```
Scatterplot: Correlation between Median Asthma Rates and CES 4.0 Score
...
ggplot(asthma_all_join, aes(x = asthma_median_by_county_ds1, y = mean_ces_score)) +
  ...
  labs(
    title = "Correlation between Median Asthma Rates and CES 4.0 Score",
